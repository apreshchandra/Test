<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCanvasAreaPromoTwo.aspx.cs"
    Inherits="DigiMa.EditCanvasAreaPromoTwo" %>
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="right">
                    <tr valign="middle" align>
                        <td align="left" colspan="1">
                            <a href="LandingPage.aspx" style="color: White;">Back</a>
                        </td>
            ...
            <div id="divwrapper" runat="server">
                ...
                <div id="steps" runat="server">
                    ...
                    <fieldset class="step">
                        ...
                        <table id="tblStep1" class="tblNEWUI">
                    ...
                    <fieldset class="step">
                        ...
                        <table id="tblPromo2Step2" cellspacing="8" class="tblNEWUI">
                            ...
                            <tr align="left" class="d1">
                                ...
                                <td align="left">
                                    <asp:FileUpload ID="filePromo2" runat="server" CssClass="textboxesPromo" />
                                </td>
                                <td>
                            ...
                            <tr class="d0" valign="middle" align="left">
                                ...
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="txtCustomTabNamePromo2" runat="server" MaxLength="20" CssClass="textboxesPromo"></asp:TextBox><asp:RequiredFieldValidator
                                        ID="RequiredFieldValidator1" ControlToValidate="txtCustomTabNamePromo2" runat="server"
                                        ErrorMessage="Custom Tab Name is a mandatory field!" ValidationGroup="vGRoupWidgets"
                            ...
                            <tr align="left" valign="middle" class="d1">
                                ...
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="txtInquiryEmail" runat="server" /><asp:CustomValidator ID="inquiryCustValidator"
                                        runat="server" ClientValidationFunction="CheckInquiry" ValidationGroup="vGRoupWidgets"
                                        Display="None" ErrorMessage="Inquiry Email is required if selected!"></asp:CustomValidator><asp:RegularExpressionValidator
                                            ...
                                            ValidationGroup="vGRoupWidgets" Display="None">  
                            ...
                            <tr align="center" valign="middle" class="d1">
                                <td colspan="4">
                                    <asp:Button ID="btnStep3Complete" runat="server" OnClick="btnStep3Complete_Click"
                                        OnClientClick="SetTabStatus3()" CssClass="btnSavenContinue" ValidationGroup="vGRoupWidgets"
                                        EnableViewState="false" ViewStateMode="Disabled"></asp:Button>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:ValidationSummary ID="ValidationSummary2" runat="server" ValidationGroup="vGRoupWidgets"
                    ...
                    <asp:HiddenField ID="hdnWidthStatus" runat="server" />
                    <asp:HiddenField ID="hdnHeightStatus" runat="server" />
                    <asp:HiddenField ID="hdnFileHeaderHasFile" runat="server" />
                    <asp:HiddenField ID="hdnFileContentHasFile" runat="server" />
                    <asp:HiddenField ID="hdnFileFooterHasFile" runat="server" />
