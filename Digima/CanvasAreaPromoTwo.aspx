<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanvasAreaPromoTwo.aspx.cs"
    Inherits="DigiMa.CanvasAreaPromoTwo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SetTabStatus3() {
            ...
            document.getElementById('btnPreviewCampaign').disabled = false;
        }
    ...
    <div class="masterbody">
        ...
        <div id="contents" runat="server">
            <input id="btnPreviewCampaign" type="button" onclick="callModalPopUp('PreviewApp.aspx?TDID=3&PDID='); return false;"
                style="margin-left: 679px;" value="Preview" disabled="disabled" runat="server" />
                ...
                <div id="steps" runat="server" tabindex="-1">
                    ...
                    <fieldset class="step">
                        ...
                        <table id="tblStep1" class="tblNEWUI" cellspacing="8">
                            <tr align="left" class="d0">
                                ...
                                <td>
                                    <asp:TextBox ID="txtCanvasHeight" runat="server" Text="700" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr align="left" class="d1">
                                ...
                                <td>
                                    <asp:TextBox ID="txtCanvasWidth" runat="server" Text="500" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr valign="middle" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    ...
                                    Choose Only .png/.jpg/.jpeg images. <span id="span1" runat="server"></span>
                                </td>
                            </tr>
                    ...
                    <fieldset class="step">
                        ...
                        <table id="tblPromo2Step2" cellspacing="8" class="tblNEWUI">
                            ...
                            <tr align="left" class="d1">
                                <td align="left">
                                    Body Image :<span style="color: Red">*</span>
                                </td>
                                <td align="left">
                                    <asp:FileUpload ID="filePromo2" runat="server" CssClass="textboxesPromo" /><asp:RequiredFieldValidator
                                        ID="rfvFilePRomo2" ControlToValidate="filePromo2" runat="server" ErrorMessage="Body Image is a mandatory field!"
                                        ValidationGroup="vGRoupBody" Display="None"></asp:RequiredFieldValidator>
                                </td>
                                <td>
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerStart" class="textboxesCalender" runat="server"
                                        readonly="readonly" /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="datepickerStart"
                                            runat="server" ErrorMessage="Start Date is a mandatory field!" ValidationGroup="vGRoupBody"
                            ...
                            <tr valign="middle" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerEnd" class="textboxesCalender" runat="server" readonly="readonly" /><asp:RequiredFieldValidator
                                        ID="RequiredFieldValidator2" ControlToValidate="datepickerEnd" runat="server"
                                        ErrorMessage="End Date is a mandatory field!" ValidationGroup="vGRoupBody" Display="None"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr valign="middle" class="d1">
                                <td align="left" colspan="1">
                            ...
                            <tr align="center" valign="middle" class="d1">
                                <td colspan="3">
                                    <asp:Button ID="btnStep2Complete" runat="server" OnClick="btnStep2Complete_Click"
                                        OnClientClick="SetTabStatus2()" CssClass="btnSavenContinue" ValidationGroup="vGRoupBody"
                        ...
                        <table class="tblNEWUI" cellspacing="3">
                            <tr class="d0" valign="middle" align="left">
                                ...
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="txtCustomTabNamePromo2" runat="server" MaxLength="20" CssClass="textboxesPromo"></asp:TextBox><asp:RequiredFieldValidator
                                        ID="rfvCustomTabNamePromo2" ControlToValidate="txtCustomTabNamePromo2" runat="server"
                                        ErrorMessage="Custom Tab Name is a mandatory field!" ValidationGroup="vGRoupCT"
                                        Display="None"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr align="left" valign="middle" class="d1">
                                ...
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="txtInquiryEmail" runat="server" /><asp:CustomValidator ID="inquiryCustValidator"
                                        runat="server" ClientValidationFunction="CheckInquiry" ValidationGroup="vGRoupCT"
                                        Display="None" ErrorMessage="Inquiry Email is required if selected!"></asp:CustomValidator><asp:RegularExpressionValidator
                                            ...
                                            ValidationGroup="vGRoupCT" Display="None">  
                            ...
                            <tr align="center" valign="middle" class="d1">
                                <td colspan="4">
                                    <asp:Button ID="btnStep3Complete" runat="server" OnClick="btnStep3Complete_Click"
                                        OnClientClick="SetTabStatus3()" CssClass="btnSavenContinue" ValidationGroup="vGRoupCT"
                                        EnableViewState="false" ViewStateMode="Disabled"></asp:Button>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:ValidationSummary ID="ValidationSummary2" runat="server" ValidationGroup="vGRoupCT"
