<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanvasAreaCoupon.aspx.cs"
    Inherits="DigiMa.CanvasAreaCoupon" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateCheckBox(Source, args) {
            var chkAnswer = document.getElementById('<%= chkInquiry.ClientID %>');
            var txtEmail = document.getElementById('<%= txtInquiryEmail.ClientID %>');
    ...
    <script type="text/javascript">
        function CompareDates() {
            ...
            if (date2 < date1 || (date3 > date2) || (date1 > date3)) {
                ...
                document.getElementById('datepickerExpiry').value = '';
                return false;
            }
        }
            ...
            <div id="divwrapper" runat="server">
                <div id="navigation" style="display: none;" runat="server">
                    <ul id="MainList" runat="server">
                        <li class="selected"><a href="#">Coupon Details</a> </li>
                        ...
                        <table id="tblPromo2Step2" cellspacing="8" class="tblNEWUI">
                            ...
                            <tr align="left">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtPrizeDetails" runat="server" TextMode="MultiLine" Height="30px"
                                        MaxLength="150" Width="400px" Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox><asp:RequiredFieldValidator
                                            ID="rfvPRizeDetails" ControlToValidate="txtPrizeDetails" runat="server" ErrorMessage="Coupon Details is a mandatory field!"
                            ...
                            <tr align="left">
                                ...
                                <td colspan="1">
                                    <asp:TextBox ID="txtCoupDesc" runat="server" TextMode="MultiLine" Height="30px" MaxLength="150"
                                        Width="400px" Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox><asp:RequiredFieldValidator
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtEligibility" runat="server" TextMode="MultiLine" Height="30px"
                                        MaxLength="150" Width="400px" Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox><asp:RequiredFieldValidator
                                            ...
                                            ErrorMessage="Coupon Eligibility is a mandatory field!" ValidationGroup="vGRoup"
                                            Display="None"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr align="left">
                                <td colspan="1">
                                    Coupon Image<span style="color: Red">*</span>
                                </td>
                                <td colspan="2">
                                    <asp:FileUpload ID="fileSweepStakeHeader" runat="server" /><asp:RequiredFieldValidator
                                        ID="RequiredFieldValidator4" ControlToValidate="fileSweepStakeHeader" runat="server"
                                        ErrorMessage="Coupon Image is a mandatory field!" ValidationGroup="vGRoup" Display="None"></asp:RequiredFieldValidator>
                            ...
                            <tr align="left">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtCoupCode" runat="server" TextMode="SingleLine" MaxLength="7"
                                        Width="400px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                            ...
                            <tr valign="middle" class="d1">
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerStart" class="textboxesCalender" runat="server"
                                        readonly="readonly" /><asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="datepickerStart"
                            ...
                            <tr valign="middle" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerEnd" class="textboxesCalender" runat="server" readonly="readonly" /><asp:RequiredFieldValidator
                                        ID="RequiredFieldValidator7" ControlToValidate="datepickerEnd" runat="server"
                            ...
                            <tr valign="middle" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerExpiry" class="textboxesCalender" runat="server"
                                        readonly="readonly" /><asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="datepickerExpiry"
                    ...
                    <fieldset class="step">
                        ...
                        <table id="tblStepOne" class="tblNEWUI" cellspacing="8">
                            ...
                            <tr align="left">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtReedem" runat="server" TextMode="MultiLine" Height="30px" MaxLength="150"
                                        Width="400px" Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator3" ControlToValidate="txtReedem" runat="server" ErrorMessage="How to Redeem is a mandatory field!"
                                            ValidationGroup="vGRoup2" Display="None"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr align="left">
                                <td valign="top" colspan="1">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtTandC" runat="server" TextMode="MultiLine" Height="30px" Width="400px"
                                        Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox>
                                </td>
                            </tr>
                            <tr align="left">
                                <td valign="top" colspan="1">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtPrivacy" runat="server" TextMode="MultiLine" Height="30px" Width="400px"
                                        Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox>
                                </td>
                            </tr>
                            <tr align="left">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtOffRules" runat="server" TextMode="MultiLine" Height="30px" Width="400px"
                                        Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox>
                                </td>
                            </tr>
                            <tr align="center" valign="middle" class="d1">
                                <td colspan="3">
                                    <asp:Button ID="btnStep2Complete" runat="server" OnClick="btnStep2Complete_Click"
                                        OnClientClick="SetTabStatus2()" CssClass="btnSavenContinue" ValidationGroup="vGRoup2"
                                        EnableViewState="false" ViewStateMode="Disabled"></asp:Button>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:ValidationSummary ID="ValidationSummary3" runat="server" ValidationGroup="vGRoup2"
                                        ShowMessageBox="true" ShowSummary="false" Class="valSummary" />
                                </td>
                            </tr>
                        </table>
