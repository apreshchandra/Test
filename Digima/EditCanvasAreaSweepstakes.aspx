<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCanvasAreaSweepstakes.aspx.cs"
    Inherits="DigiMa.EditCanvasAreaSweepstakes" %>
                        ...
                        <table id="tblStepOne" class="tblNEWUI" cellspacing="8">
                            <tr valign="middle" align="left" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    <asp:TextBox ID="txtHeaderText" runat="server" CssClass="textboxesSweepstakes" MaxLength="150"
                            ...
                            <tr align="left">
                                ...
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtEligibility" runat="server" TextMode="MultiLine" Font-Size="Small"
                                        Font-Names="MS Shell Dlg" Height="30px" MaxLength="150" Width="400px"></asp:TextBox><asp:RequiredFieldValidator
