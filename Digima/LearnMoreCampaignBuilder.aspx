<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LearnMoreCampaignBuilder.aspx.cs"
    Inherits="DigiMa.LearnMoreCampaignBuilder" %>
        ...
        <div id="mainContent">
            <div id="childContent">
                ...
                <div style="text-align: center;">
                    <span style="font-size: xx-large; font-weight: bolder; color: Silver">Campaign Builder</span>
                </div>
                <br />
                <br />
                <br />
                ...
                <table id="tblchildContent">
                    <tr align="center">
                        <td colspan="1" align="center" style="width: 50%;">
                            <br />
                            <span style="font-size: 16px; font-weight: bold; color: Silver">Promotions</span>
                        </td>
                        <td colspan="1" align="center" style="width: 50%;">
                            <br />
                            <span style="font-size: 16px; font-weight: bold; color: Silver">Video Shares</span>
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="1" align="center" style="width: 50%;">
                            <asp:Image ID="tollsnglobe" runat="server" ImageUrl="~/Images/Promotions.jpg" />
                        </td>
                        <td colspan="1" align="center" style="width: 50%;">
                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Video.jpg" />
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="1" align="center" style="width: 50%;">
                            <span style="font-size: 14px; color: Silver">Promotions build fans and fans drive sales.
                                Run world class promotions to build and engage with your audience. </span>
                        </td>
                        <td colspan="1" align="center" style="width: 50%;">
                            <span style="font-size: 14px; color: Silver">Showcase your latest creative ads with
                                fans</span>
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="1" align="center" style="width: 50%;">
                            ...
                            <br />
                            <br />
                            <span style="font-size: 16px; font-weight: bold; color: Silver">Coupons</span>
                        </td>
                        <td colspan="1" align="center" style="width: 50%;">
                            <br />
                            <br />
                            <br />
                            <br />
                            <span style="font-size: 16px; font-weight: bold; color: Silver">Sweepstakes</span>
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="1" align="center" style="width: 50%;">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Coupons.jpg" />
                        </td>
                        <td colspan="1" align="center" style="width: 50%;">
                            <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/Sweepstakes.jpg" />
                        </td>
                    </tr>
                    <tr align="center">
                        <td colspan="1" align="center" style="width: 50%;">
                            <span style="font-size: 14px; color: Silver">Monetize your fans though Coupons. Number
                                one reason why people follow brands on social media is to get access to discounts
                                and deals.</span>
                        </td>
                        <td colspan="1" align="center" style="width: 50%;">
                            <span style="font-size: 14px; color: Silver">Give fans the chance to learn about your
                                brand while competing for prizes</span>
                        </td>
                    </tr>
                    <tr align="left">
                        <td colspan="2">
                            ...
                            <br />
                            <br />
                            <span style="font-size: 20px; font-weight: bold; color: Silver">Boost your Campaigns
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <br />
                            <span style="font-size: 14px; color: Silver">Select the widgets of your choice for your
                                Promotions, which help you to maximize your reach and increasing your fan base.
                                Listen to what your fans have to say about your Promotions.</span>
                        </td>
                    </tr>
                    <tr align="left">
                        <td colspan="2">
                            ...
                            <br />
                            <br />
                            <span style="font-size: 20px; font-weight: bold; color: Silver">Like Gateway </span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <br />
                            <span style="font-size: 14px; color: Silver">Get people to follow your brand for entering
                                your promotions with the Like Gateway.</span>
                        </td>
                    </tr>
                </table>
            </div>
