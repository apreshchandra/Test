...
{
    public partial class FromLocationDrillDown2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dsAnalytics = analyticsBiz.GetLocationDrillDown2_Gender1(CustomerName, AppName, City, Gender);
            try
            {
        ...
        {
            Response.Redirect("LocationWiseDrillDown2.aspx?CustomerName=" + CustomerName + "&AppName=" + AppName + "&City=" + City + "&Gender=" + Gender + "&State=" + State + "&Count_State=" + Count_State + "&Count_Country=" + Count_Country + "&Country=" + Country + "&Count=" + Count);
        }   
