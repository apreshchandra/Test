<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanvasAreaSweepstakes.aspx.cs"
    Inherits="DigiMa.CanvasAreaSweepstakes" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#datepickerStart").removeAttr("keypress");
            $("#datepickerEnd").removeAttr("keypress");
 ...
 <asp:literal runat="server" id="litLogin"></asp:literal>
    ...
    <script type="text/javascript">
        function CompareDates() {
            ...
            var str1 = document.getElementById("datepickerEnd").value;
            ...
            if (date2 < date1) {
                alert("Draw date has to be after End Date !");
...
<body>
            ...
            <div class="topright">
                <table cellpadding="0" cellspacing="0" border="0" align="right">
                    <tr valign="middle" align>
                        ...
                        <td align="left" colspan="1">
                            <a href="Home.aspx?lo=T" class="toplink" id="loginButton">Logout</a>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div id="divwrapper" runat="server">
                <div id="navigation" style="display: none;" runat="server">
                    <ul id="MainList" runat="server">
                        <li class="selected"><a href="#">Sweepstakes Settings</a> </li>
                        <li runat="server" id="CampDetails"><a href="#" id="campDetLinker">Sweepstakes Details</a>
                        </li>
                ...
                <div id="steps" runat="server">
                    ...
                    <fieldset class="step">
                        <legend>Sweepstakes Details</legend>
                        <table id="tblStepOne" class="tblNEWUI" cellspacing="8">
                            ...
                            <tr align="left">
                                <td colspan="1">
                                    Header Banner<span style="color: Red">*</span>
                                </td>
                                <td colspan="2">
                                    <asp:FileUpload ID="fileSweepStakeHeader" runat="server" /><asp:RequiredFieldValidator
                                        ...
                                        ErrorMessage="Header Banner is a mandatory field!" ValidationGroup="vGRoup" Display="None"></asp:RequiredFieldValidator>
                            ...
                            <tr align="left">
                                <td valign="top" colspan="1">
                                    <label for="first_name">
                                        Prize Details<span style="color: Red">*</span></label>
                                </td>
                                <td valign="top" colspan="2">
                                    <asp:TextBox ID="txtPrizeDetails" runat="server" TextMode="MultiLine" Height="30px"
                                        MaxLength="150" Width="400px" Font-Size="Small" Font-Names="MS Shell Dlg"></asp:TextBox><asp:RequiredFieldValidator
                                            ID="rfvPRizeDetails" ControlToValidate="txtPrizeDetails" runat="server" ErrorMessage="Prize Details is a mandatory field!"
                            ...
                            <tr align="left">
                                <td valign="top" colspan="1">
                                    <label for="last_name">
                                        Eligibility<span style="color: Red">*</span></label>
                                </td>
                                <td valign="top" colspan="2">
                            ...
                            <tr valign="middle" class="d1">
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerStart" class="textboxesCalender" runat="server"
                                        readonly="readonly" /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="datepickerStart"
                            ...
                            <tr valign="middle" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerEnd" class="textboxesCalender" runat="server" readonly="readonly" />
                                </td>
                            </tr>
                            <tr valign="middle" class="d0">
                                <td align="left" colspan="1">
                                    <label for="endDate">
                                        Draw Date <span style="color: Red">*</span></label>
                                </td>
                                <td align="left" colspan="2">
                                    <input type="text" id="datepickerExpiry" class="textboxesCalender" runat="server"
                                        readonly="readonly" /><asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="datepickerExpiry"
                                            runat="server" ErrorMessage="Draw Date is a mandatory field!" ValidationGroup="vGRoup"
                                            Display="None"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" colspan="1">
                                    <label for="endDate">
                                        Sweepstakes Winners<span style="color: Red">*</span></label>
                                </td>
                                <td align="left" colspan="2" style="width: 20px;">
                                    <asp:DropDownList ID="ddlSelectWinner" runat="server" Width="148px">
                                        <asp:ListItem Value="0">Select Winners</asp:ListItem>
                                        <asp:ListItem Value="1">1</asp:ListItem>
                                        <asp:ListItem Value="2">2</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="ddlSelectWinner"
                                        runat="server" InitialValue="0" ErrorMessage="Sweepstakes Winners a mandatory field!"
                                        ValidationGroup="vGRoup" Display="None"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                    ...
                    <fieldset class="step">
                        <legend>Sweepstake Rules </legend>
                        <table id="tblPromo2Step2" class="tblNEWUI" cellspacing="8">
                            <tr valign="middle" class="d0">
                                <td align="left" colspan="1">
                                    Banner Image :
                                </td>
    ...
    <div id="popupContact">
        ...
        <p id="para1" style="text-decoration: underline; font-weight: bold;">
        </p>
        <p id="para">
        </p>
    </div>
