<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCanvasAreaPromoVideo.aspx.cs"
    Inherits="DigiMa.EditCanvasAreaPromoVideo" %>
                ...
                <div id="steps" runat="server">
                    ...
                    <fieldset class="step">
                        ...
                        <table id="tblPromo2Step2" cellspacing="8" class="tblNEWUI">
                            ...
                            <tr valign="middle" class="d0" align="left">
                                <td align="left" colspan="1">
                                    Header Caption :
                                </td>
                                <td align="left" colspan="2">
                            ...
                            <tr valign="middle" class="d0">
                                ...
                                <td align="left" colspan="2">
                                    ...
                                    Choose Only .png/.jpg/.jpeg images. <span id="spnErrorPromoVid" runat="server"></span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="vGRoupVideo"
