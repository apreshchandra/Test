<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pricing.aspx.cs" Inherits="DigiMa.Pricing" %>
...
<body>
    ...
    <div class="masterbody">
            ...
            <div class="menu_bg">
                <div id="ddtopmenubar" class="mattblackmenu">
                    <ul>
                        ...
                        <li><a href="#"><span>
                            <img src="images/nav_sep.png" border="0" /></a></span></li>
                        <li><a href="Contact.aspx">Contact Us</a></li><li><a href="#"><span>
                            <img src="images/nav_sep.png" border="0" /></a></span></li>
        ...
        <div id="mainContent">
            <br />
            <div style="color: #5fcdf6; text-align: center;">
                <h3>
                    For Pricing details contact us at <a href="mailto:sales@smnetserv.com" style="color: White;">
                        sales@smnetserv.com</a> or you can call us on +91-80-40400800</h3>
            </div>
        </div>
    </div>
    <div id="QRBottom">
